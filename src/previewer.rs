...
pub struct Previewer {
    ...
    prev_item: Option<Arc<dyn for<'a> SkimItem<'a>>>,
...
impl Previewer {
    ...
    pub fn on_item_change(
        ...
        new_item: impl Into<Option<Arc<dyn for<'a> SkimItem<'a>>>>,
        new_query: impl Into<Option<String>>,
        new_cmd_query: impl Into<Option<String>>,
        num_selected: usize,
        get_selected_items: impl Fn() -> (Vec<usize>, Vec<Arc<dyn for<'a> SkimItem<'a>>>), // lazy get
        force: bool,
    ) {
